...
import SamplePerson from 'Frontend/generated/com/jbpmtask/application/data/entity/SamplePerson';
import SamplePersonModel from 'Frontend/generated/com/jbpmtask/application/data/entity/SamplePersonModel';
...
@customElement('person-detail-view')
export class PersonDetailView extends View {
  @query('#grid')
  private grid!: Grid;
